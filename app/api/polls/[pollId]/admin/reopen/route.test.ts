...
describe('POST /api/polls/[pollId]/admin/reopen', () => {
  ...
  it('should reopen a poll with valid control token', async () => {
    // Arrange
    const mockUpdatedPoll = { ...mockPoll, closed: false };
    ...
    const request = new NextRequest('http://localhost:3000/api/polls/test-poll-id/admin/reopen', {
      method: 'POST',
  ...
  it('should return 500 when database operation fails', async () => {
    ...
    expect(data.error.message).toBe('Failed to reopen poll');
