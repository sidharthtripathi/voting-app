...
/**
 * POST /api/polls/[pollId]/admin/reopen
 * Reopen a closed poll (requires valid control token)
...
export async function POST(
  ...
  try {
    ...
    // Update poll closed status to false
    ...
    try {
      ...
      await pusher.trigger(channelName, PUSHER_EVENTS.POLL_REOPENED, {
